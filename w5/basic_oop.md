1.**Обеъкт**: __Объект__ - это сущность с состоянием и поведением.Все в Python - это объект, и почти все имеет свойства и методы. Все функции имеют встроенное свойство __doc__,
